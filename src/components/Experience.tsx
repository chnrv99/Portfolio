                        ...
                        <CardHeader>
                            <div className="flex justify-between">
                                ...
                                <CardDescription className="lg:flex lg:flex-row sm:flex-col md:flex-col">
                                    <Badge className="lg:mr-2 md:mb-2 bg-red-200">MERN</Badge>
                                    <Badge className="lg:mr-2 md:mb-2 bg-blue-200">AWS</Badge>
                                    <Badge className="lg:mr-2 md:mb-2 bg-violet-200">git</Badge>
                                </CardDescription>
                        ...
                        <Card className={cn("w-auto h-auto  hover:bg-slate-900 hover:text-slate-200 transition-colors", className)} {...props}>
                            <CardHeader>
                                <div className="flex justify-between">
                                    ...
                                    <CardDescription className="lg:flex lg:flex-row sm:flex-col md:flex-col">
                                        <Badge className="lg:mr-2 md:mb-2 bg-slate-200">Open source</Badge>
                                        <Badge className="lg:mr-2 md:mb-2 bg-green-200">Azure</Badge>
                                        <Badge className="lg:mr-2 md:mb-2 bg-orange-200">Flask</Badge>
                            ...
                            <CardHeader className="">
                                <div className="flex justify-between">
                                    ...
                                    <CardDescription className="sm:hidden md:hidden lg:flex lg:flex-row">
                                        <Badge className="lg:mr-2 md:mb-2 bg-amber-200">Next.js</Badge>
                                        <Badge className="lg:mr-2 md:mb-2 bg-lime-200">MERN</Badge>
                                        <Badge className="lg:mr-2 md:mb-2 bg-emerald-200">Azure</Badge>
                                        <Badge className="lg:mr-2 md:mb-2 bg-indigo-200">Hacking</Badge>
                                    </CardDescription>
